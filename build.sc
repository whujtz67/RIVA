...
import scalalib._
import scalafmt._
import $file.chisel_deps.`rocket-chip`.common
import $file.chisel_deps.`rocket-chip`.dependencies.hardfloat.common
import $file.chisel_deps.`rocket-chip`.dependencies.cde.common
...
object cde extends CommonModule {
  override def millSourcePath = os.pwd / "chisel_deps" / "rocket-chip" / "dependencies" / "cde" / "cde"
}

object diplomacy extends CommonModule {
  override def millSourcePath = os.pwd / "chisel_deps" / "rocket-chip" / "dependencies" / "diplomacy" / "diplomacy"
...
object rocketchip extends millbuild.chisel_deps.`rocket-chip`.common.RocketChipModule {
  ...
  object hardfloat extends CommonModule {
    override def millSourcePath = os.pwd / "chisel_deps" / "rocket-chip" / "dependencies" / "hardfloat" / "hardfloat"
  }

  object macros extends millbuild.chisel_deps.`rocket-chip`.common.MacrosModule with SbtModule {
    def scalaVersion: T[String] = T(defaultVersions("scala"))
...
object xsutils extends SbtModule with CommonModule {
  override def millSourcePath = os.pwd / "chisel_deps" / "xs-utils"
