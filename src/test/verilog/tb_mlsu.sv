// ============================================================================
// tb_mlsu.sv
// MLSU Testbench for cocotb integration
// ============================================================================
...
// -----------------------------------------
module tb_top import mlsu_pkg::*; import riva_pkg::*; (
...
// -----------------------------------------
// Parameters for MLSU (following existing code patterns)
// -----------------------------------------
  // Core parameters (from MLSU.sv)
  ...
  // PE Request Type - contains only the fields needed for MLSU
  typedef struct packed {
    ...
    riva_pkg::elen_t    baseAddr;     // Base address for the matrix operation
  ...
  // PE Response Type - minimal definition for MLSU
  typedef struct packed {
...
// -----------------------------------------
  // MLSU Request Interface - expanded from pe_req_t
  reg                       pe_req_valid;
  wire                      pe_req_ready;
  ...
  // Lane Interface - Transmit lanes (MLSU to lanes)
  wire                        txs_0_valid;
  wire                        txs_1_valid;
  wire                        txs_2_valid;
  wire                        txs_3_valid;
  ...
  maddr_set_t                 txs_0_bits_maddr_set;
  maddr_set_t                 txs_1_bits_maddr_set;
  maddr_set_t                 txs_2_bits_maddr_set;
  maddr_set_t                 txs_3_bits_maddr_set;
  maddr_bank_t                txs_0_bits_maddr_bank;
  maddr_bank_t                txs_1_bits_maddr_bank;
  maddr_bank_t                txs_2_bits_maddr_bank;
  maddr_bank_t                txs_3_bits_maddr_bank;
  ...
  // Lane Interface - Receive lanes (lanes to MLSU)
  reg                         rxs_0_valid;
  reg                         rxs_1_valid;
  reg                         rxs_2_valid;
  reg                         rxs_3_valid;
...
// -----------------------------------------
  MLSU #(
    ...
    .txs_maddr_set_o          ({txs_3_bits_maddr_set, txs_2_bits_maddr_set, txs_1_bits_maddr_set, txs_0_bits_maddr_set}),
    .txs_maddr_bank_o         ({txs_3_bits_maddr_bank, txs_2_bits_maddr_bank, txs_1_bits_maddr_bank, txs_0_bits_maddr_bank}),
